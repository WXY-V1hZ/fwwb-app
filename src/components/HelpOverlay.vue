      ...
      <div class="help-content fade-in" @click.stop>
        ...
        <div class="help-sections">
          <div class="help-section">
            <h3>项目介绍</h3>
            <p>本系统旨在解决浓烟环境下人体目标难以识别的问题，通过结合红外视频和热成像视频，借助深度学习算法实现准确的人体目标检测，为消防救援工作提供技术支持。</p>
          </div>

          <div class="help-section">
            <h3>视频上传</h3>
            <p>系统需要同时上传红外视频和热成像视频才能进行处理。点击左侧控制面板中的"选择文件"按钮可以上传相应视频。</p>
            <div class="help-tips">
              <div class="tip-item">
                <div class="tip-icon">提示</div>
                <div class="tip-text">支持常见视频格式：MP4、AVI等</div>
              </div>
            </div>
          </div>
          ...
          <div class="help-section">
            ...
            <ol class="help-list">
              ...
              <li>在右侧输出区域观看处理后的视频，该视频中包含人体目标检测结果</li>
            </ol>
          </div>

          <div class="help-section">
            <h3>历史记录</h3>
            <p>系统会自动保存处理结果到本地，您可以在左侧控制面板的历史记录区域查看和加载之前处理过的视频。</p>
            <div class="help-tips">
              <div class="tip-item">
                <div class="tip-icon">提示</div>
          ...
          <div class="help-section">
            <h3>技术原理</h3>
            <p>本系统采用深度学习目标检测算法，通过分析红外视频和热成像视频的特征，实现对浓烟环境中人体目标的精确识别和定位。系统会在输出视频中绘制人体目标的边界框并显示检测置信度。</p>
          </div>
        </div>
      </div>
    </div>
